...
const AuthForm = ({
    ...
    return (
        <div>
            ...
            { page === "profile" &&
                <>
                <FloatingLabel className="my-3" label="Username">
                <Form.Control type="text" name="username" value={username} onChange={e => SetUsername(e.target.value)} placeholder="Username" />
                </FloatingLabel>
                <FloatingLabel className="my-3" label="Write About you">
                <Form.Control type="text" name="about" value={about} onChange={e => SetAbout(e.target.value)} placeholder="Write About you" />
                </FloatingLabel>
                </>
            }
            ...
            <FloatingLabel
                ...
                className="mb-3"
            >
                <Form.Control type="email" name="email" value={email} onChange={e => SetEmail(e.target.value)} placeholder="name@example.com" disabled={page==="profile"} />
            </FloatingLabel>
            ...
            <FloatingLabel className="my-3" label="Write Answer Here">
            ...
            <Button type="submit" className="col-12"
                disabled={ page==="profile" ? loading : page === "login"? !email || !password : !name || !email || !password || !security}
            >
